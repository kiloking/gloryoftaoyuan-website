...
function Section4({bgimg}) {
  ...
  return (
    <div id="section4" name="link3"  className="header min-h-screen relative bg-[#40220e] ">
      ...
      <div 
        className='absolute bg-no-repeat bg-cover bg-center-top  hidden xs:block min-h-screen w-full'
      ...
      <div className='z-10 w-9/12  relative mx-auto py-36 xs:w-full xs:py-24 '>
