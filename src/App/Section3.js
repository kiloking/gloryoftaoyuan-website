...
function Section3() {
 ...
 >
      ...
      <div className='w-4/5 mx-auto my-10 hidden xs:block'>
        ...
        <div className='text-white text-base drop-shadow-lg mt-10'>桃園龜山多年等待！致敬在地精英。「中興特區」珍稀都心重劃區，擁站前、中興路、萬壽路三大商圈機能，未來捷運棕線BRH2巨蛋站僅600公尺之遙，火車站、雙國道完善聯外路網；桃林鐵路步道僅600公尺、近鄰三民公園、虎頭山萬頃森林，周邊生活機能成熟，朗闊大境視野無限，胸懷大景生活從容。</div>
      </div>
